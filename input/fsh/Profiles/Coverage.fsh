...
* extension contains ExtensionBoolPrais named Prais 0..1 MS
...
* class.type = #class
* class.value 1..1
* class.value ^short = "Tramo FONASA o Nombre Isapre"
* class.value ^definition = "Tramo FONASA o Nombre Isapre"
* class.name 1..1 
* class.name ^short = "Descripción: Fonasa Tramo A o Isapre Los Palermos"
* class.name ^definition = "Descripción completa del valor, Ej: Fonasa Tramo A, Isapre Los Palermos"
* payor 1..1
* payor.display 1..1 
